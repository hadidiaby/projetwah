...
?>
      ...
      <h1 class="mt-5">personnel</h1>
      <a href="addpersonnel.php" class="btn btn-primary" style="float:right;margin-bottom:20px;">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  Voulez-vous vraimentsupprimer cet employé ?
                </div>
                <div class="modal-footer">
                  <a href="" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</a>
                  <a href="supprimer.php?id=<?php echo  $ligne["id"] ?>"  class="btn btn-danger">Supprimer</button>
                </div>
              </div>
            </div>
          </div>
